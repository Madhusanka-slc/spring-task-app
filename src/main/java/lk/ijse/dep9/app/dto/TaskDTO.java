...
public class TaskDTO implements Serializable {
    ...
    private Integer id;
    @NotBlank(message = "Task can't be empty or null")
    private String content;
    @Null(groups = {ValidationGroups.Create.class,ValidationGroups.Update.class},message = "Task projectId can't be specified")
